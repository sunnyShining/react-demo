...
function setupCompiler(host, port, protocol) {
    ...
    compiler.plugin('done', function(stats) {
        ...
        if (showInstructions) {
            ...
            console.log('To create a staging build, use ' + _chalk2.default.cyan('npm run build:stg') + '.');
            console.log('To create a  production build, use ' + _chalk2.default.cyan('npm run build:prd') + '.');
            console.log();
