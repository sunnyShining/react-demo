...
function getConfig(configFile, paths) {
  ...
  if ((0, _fs.existsSync)(rcConfig)) {
    if (process.env.NODE_ENV === 'development' && (0, _fs.existsSync)(jsConfig)) {
      console.error('Config error: You must delete ' + rcConfig + ' if you want to use ' + jsConfig);
    }
    return (0, _parseJsonPretty2.default)((0, _stripJsonComments2.default)((0, _fs.readFileSync)(rcConfig, 'utf-8')), configFile);
