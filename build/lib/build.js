...
const science = process.argv.slice(2)[0];
process.env.NODE_ENV = science || 'production';
console.log(`你当前所处环境为${science}`);
...
function realBuild(previousSizeMap, resolve, argv) {
  if (argv.debug) {
    ...
    console.log(`Creating an optimized ${science} build...`);
  }
